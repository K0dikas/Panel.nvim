...
local PanelBufHighlights = require("panel.service.buffer.highlights")

---@class NotificationBuf
---@field highlights PanelBufHighlights
---@field _config table
...
function NotificationBuf:_create_highlights()
	...
	self.highlights = PanelBufHighlights(self._notif.level, self._buffer, self._config)
...
function NotificationBuf:render()
	...
	local render_namespace = require("panel.render.base").namespace()
	api.nvim_buf_set_option(buf, "filetype", "panel")
